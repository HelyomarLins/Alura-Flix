...
export const Panel = ({
  ...
  async function trailerID() {
    if (linkVideo === "") {
      ...
      setLinkVideo(
        `https://www.youtube.com/embed/${hashVideo}?si=ZQrkDkNQwzSw7wqp&amp;controls=0`
      );
    }
  ...
  return (
    <>
        ...
        <ContainerPanelStyled $isfocused={isfocused}>
          ...
          >
            ...
            <ContainerBottomStyled $isfocused={isfocused}>
              ...
              <TextDescribeStyled>{describe}</TextDescribeStyled>
      ...
      <Dialog
        showModal={showModal}
        functionShowModal={() => setShowModal(!showModal)}
        linkVideo={linkVideo as string}
      ></Dialog>
